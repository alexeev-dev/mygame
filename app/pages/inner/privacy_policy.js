...
class InnerPrivacyPage extends Component {
  render() {
    return (
      <div id="content-block">
    		<div className="container be-detail-container">
    			<div className="blog-wrapper blog-list blog-fullwith">
    						...
    						<div className="blog-post be-large-post type-2" >
    							<div className="be-large-post-align blog-content">
    								<div className="be-text-tags clearfix custom-a-b">
    									...
    									<div className="author-post">
    										...
    										<span>by <a href="#">Hoang Nguyen</a></span>
    									</div>
    								</div>
    							...
    							<div className="blog-content be-large-post-align">
    								<div className="post-text ">
    									...
    									<img className="img-leftblog" src="img/blog_img_3.jpg" alt="" />
    									...
    									<img className="img-fullblog" src="img/blog_img_4.jpg" alt="" />
...
export default InnerPrivacyPage;
